...
@push('script-bottom')
    <script>
        // Swal.fire({
        //     title: 'Berhasil!',
        //     text: 'referensi berhasil dihapus',
        //     icon: 'success',
        ...
        function hapus(id) {
            ...
            Swal.fire({
                ...
                text: "referensi yang dihapus tidak dapat dikembalikan!",
                icon: 'warning',
...
@section('content')
    <div class="grid grid-cols-2 gap-4 mb-14">
        <div class="px-14 w-full space-y-5">
            {{-- BUTTON KUNING --}}
            <a href="{{ route('referensi-guru.create') }}"
            ...
            <div class="w-full max-h-72 overflow-scroll space-y-6">
                <div class="flex items-center">
                    <h1 class="flex-grow text-xl font-semibold">Daftar referensi</h1>
                ...
                @forelse ($referensis as $item)
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="w-24 flex items-center justify-between">
                            <a href="{{ route('referensi-guru.edit', ['referensi_guru' => $item->id]) }}">
                            ...
                            <div id="1-item" class="text-center space-y-1 text-merah cursor-pointer"
                                ...
                                <form action="{{ route('referensi-guru.destroy', ['referensi_guru' => $item->id]) }}"
                ...
                @empty
                    ...
                    -center justify-center w-full h-36 bg-white rounded-lg shadow-md">
                        <p class="text-lg text-netral">Belum ada referensi</p>
                    </div>
                @endforelse
        ...
        <div class="px-4">
            <div class="p-4 rounded-lg shadow-md">
                <h1 class="text-xl text-kuning font-semibold text-center mb-6">Detail Referensi</h1>
                ...
                <form action="{{ route('referensi-guru.store') }}" method="post" class="space-y-3"
                    ...
                    <div class="mt-8">
                        @if ($referensi->dokumen)
                            <a href="{{ asset('storage/referensi/dokumen/' . $referensi->dokumen) }}" target="_blank"
                    ...
                    {{-- <div class="space-y-2">
                        <p>Upload File</p>
                        <input type="file" name="dokumen" class="w-full border rounded p-1">
                    </div> --}}
