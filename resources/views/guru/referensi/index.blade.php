...
@section('content')
    <div class="grid grid-cols-2 gap-4 mb-14">
                ...
                @forelse ($referensis as $item)
                    ...
                    <div class="flex items-center gap-3">
                        <a href="{{ route('referensi-guru.show', ['referensi_guru' => $item->id]) }}"
                            ...
                            <h1 class="text-lg font-semibold text-netral text-center">{{ $item->nama }}</h1>
        ...
        <div class="flex flex-col gap-2 justify-center items-center mt-24">
            <img src="{{ asset('assets/image/pilih referensi.png') }}" alt="">
            <p class="text-[#B0ACAC]">Silakan Pilih referensi anda</p>
        </div>
    </div>
@endsection
