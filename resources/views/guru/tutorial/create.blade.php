...
@push('script-bottom')
    <script>
        // Swal.fire({
        //     title: 'Berhasil!',
        //     text: 'tutorial berhasil dihapus',
        //     icon: 'success',
        ...
        function hapus(id) {
            ...
            Swal.fire({
                ...
                text: "tutorial yang dihapus tidak dapat dikembalikan!",
                icon: 'warning',
...
@section('content')
    <div class="grid grid-cols-2 gap-4 mb-14">
        <div class="px-14 w-full space-y-5">
            {{-- BUTTON KUNING --}}
            <a href="{{ route('tutorial-guru.create') }}"
            ...
            <div class="w-full max-h-72 overflow-scroll space-y-6">
                <div class="flex items-center">
                    <h1 class="flex-grow text-xl font-semibold">Daftar tutorial</h1>
                ...
                @forelse ($tutorials as $item)
                    ...
                    <div class="flex items-center gap-3">
                        <a href="{{ route('tutorial-guru.show', ['tutorial_guru' => $item->id]) }}"
                        ...
                        <div class="w-24 flex items-center justify-between">
                            <a href="{{ route('tutorial-guru.edit', ['tutorial_guru' => $item->id]) }}">
                            ...
                            <div id="1-item" class="text-center space-y-1 text-merah cursor-pointer"
                                ...
                                <form action="{{ route('tutorial-guru.destroy', ['tutorial_guru' => $item->id]) }}"
                ...
                @empty
                    ...
                    -center justify-center w-full h-36 bg-white rounded-lg shadow-md">
                        <p class="text-lg text-netral">Belum ada tutorial</p>
                    </div>
                @endforelse
        ...
        <div class="px-4">
            <div class="p-4 rounded-lg shadow-md">
                <h1 class="text-xl text-kuning font-semibold text-center mb-6">Tambah tutorial</h1>
