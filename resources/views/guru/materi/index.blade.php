        ...
        <div class="px-14 w-full space-y-5">
            ...
            <div class="w-full space-y-6">
                ...
                <div class="flex items-center gap-3">
                    <button class="flex-grow flex justify-between items-center px-4 py-1 border rounded">
                        ...
                        <h1 class="text-lg font-semibold text-netral">Dasar-dasar CSS</h1>
                ...
                <div class="flex items-center gap-3">
                    <button class="flex-grow flex justify-between items-center px-4 py-1 border rounded">
                        ...
                        <h1 class="text-lg font-semibold text-netral">Dasar-dasar Python</h1>
                ...
                <div class="flex items-center gap-3">
                    <button class="flex-grow flex justify-between items-center px-4 py-1 border rounded">
                        ...
                        <h1 class="text-lg font-semibold text-netral">Dasar-dasar Html</h1>
