...
@section('content')
    <div class="grid grid-cols-2 gap-4 mb-14">
        ...
        <div class="flex flex-col gap-2 items-center overflow-x-hidden">
            <table class="border-spacing-x-2 border-spacing-y-2 border-separate text-center">
                <thead>
                    <tr class=" text-blue-border">
                        ...
                        <th class="rounded font-thin text-center px-12 border-1 border-kuning">Nama Kuis</th>
                        <th class="rounded font-thin text-center px-12 border-1 border-kuning">Nilai</th>
                        {{-- aksi --}}
                ...
                <tbody>
                    ...
                    {{-- <tr>
                        ...
                        <td class="flex items-center justify-center gap-2  py-2  text-white rounded">
                            100
                        </td>
                    </tr> --}}
                    {{-- @endforelse --}}
