    ...
    <div class="grid grid-cols-2 gap-4 mb-14">
        ...
        <div class="px-4">
            <div class="p-4 rounded-lg shadow-md">
                <h1 class="text-xl text-kuning font-semibold text-center mb-6">Tambah Kuis</h1>

                <form action="{{ route('kategori.store') }}" method="post" class="space-y-3" enctype="multipart/form-data">
                    @csrf
                    @method('POST')

                    <div class="space-y-2">
                        <p>Judul Kuis</p>
                        <input type="text" name="kuis" class="w-full border-1 rounded p-1 border-blue-border"
                            value="{{ $kategori->kuis }}" readonly>
                    </div>

                    <div class="space-y-2">
                        <p>Deskripsi Kuis</p>
                        {{-- textarea --}}
                        <textarea name="deskripsi" readonly id="deskripsi" class="w-full border-1 rounded p-1 border-blue-border">{{ $kategori->deskripsi }}</textarea>
                    </div>

                    {{-- tenggat_waktu --}}
                    <div class="space-y-2">
                        <p>Masukkan Tenggat Waktu:</p>
                        <input type="date" readonly id="tenggat_waktu" name="tenggat_waktu"
