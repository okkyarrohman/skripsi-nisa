...
@section('content')
    <div class="grid grid-cols-5 gap-4 mb-14">
        ...
        <div class="flex flex-col gap-2 justify-center items-center mt-14 col-span-2">
            <img src="{{ asset('assets/image/pilih tugas.png') }}" alt="">
            <p class="text-[#B0ACAC]">Silakan Pilih tugas anda</p>
