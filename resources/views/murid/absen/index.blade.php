        ...
        <div class="ml-3">
            ...
            <form action="{{ route('absen.store') }}" method="POST">
                ...
                <div class="flex items-center gap-5 mt-6">
                    ...
                    <input name="nama" type="text" placeholder="Masukkan Nama" class="border w-96 p-2 ml-14">
                </div>
                <div class="flex items-center gap-5 mt-6">
                    <label for="absen" class=" font-semibold">Nomor absen</label>
                    <input name="absen" type="text" placeholder="Masukkan No Absen" class="border w-96 p-2">
                </div>
